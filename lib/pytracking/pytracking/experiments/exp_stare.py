...
# Define the list of stream settings for evaluation
stream_settings=(
    "esot500_stare_w2ms"
    "esot500_stare_w20ms"
    "esot500_stare_w50ms"
    "esot500_stare_w100ms"
    "esot500_stare_w150ms"
    "esot500_stare_w200ms"
)

# Loop through each stream setting
for setting in "${stream_settings[@]}"; do
